...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                             ...
                             QComboBox, QFileDialog, QMessageBox, QProgressBar, QDialog, QListWidgetItem)
...
class FileOrganizerApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.combobox_tema.addItems(["Claro", "Neon"])
        ...
        main_layout.addWidget(self.panel_config)
        ...
        main_layout.addWidget(self.panel_visualizacao, stretch=1)
        ...
        acoes_layout.addWidget(self.button_clear_log)
        acoes_layout.addWidget(self.button_export_log)
        acoes_layout.addWidget(self.button_undo)
    ...
    def apply_theme(self, theme: str):
        ...
        if theme == "Neon":
            self.setStyleSheet("""
                QWidget { background: #000000; color: #00FF00; }
    ...
    def load_initial_config(self):
        config = self.load_config()
        theme = config["Settings"].get("theme", "Claro")
